...
# Introduction
  ...
  In this report, I will analyze how the number of people using the Toronto shelter system changes in Toronto from 2020 to 2021. Moreover, I will discuss the ethical bias in the data and the underlying implications it might cause. All analysis was done with an open-source statistical programming language R [@citeR].
...
Then show an extract of the dataset (Table \@ref(tab:dataextract)). From the table, we can see that most of the homeless are young adults and middle-aged people. Aged population and youths only account for a small portion. 
